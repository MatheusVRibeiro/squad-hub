                      ...
                      <CardContent className="space-y-4 p-6">
                        <div className="flex items-center gap-2">
                          ...
                          {!isMember && (
                            <Badge
                              variant="outline"
                              className="h-5 gap-1 rounded-full border-amber-500/20 bg-amber-500/10 text-[10px] text-amber-700 dark:text-amber-400"
                            >
                              ...
                              {isMember ? (
                                data.figmaUrl ? (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="block truncate text-xs font-semibold text-rose-600 hover:underline"
                                  >
                                    Abrir figma
                                  </a>
                                ) : (
                              ...
                              {isMember ? (
                                data.discordUrl ? (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="block truncate text-xs font-semibold text-indigo-600 hover:underline"
                                  >
                                    Entrar no chat
                                  </a>
                                ) : (
                              ...
                              {isMember ? (
                                data.documentacaoUrl ? (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="block truncate text-xs font-semibold text-amber-600 hover:underline"
                                  >
                                    Notion/Wiki
                                  </a>
                                ) : (
